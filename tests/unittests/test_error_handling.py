...
@mock.patch("tap_twitter_ads.sync.Request")
class TestExceptionHandling(unittest.TestCase):
    ...
    @mock.patch("tap_twitter_ads.sync.Cursor", side_effect=Mockresponse(400))
    def test_400_error_custom_message(self, mocked_cursor, mocked_request):
        ...
        with self.assertRaises(client.TwitterAdsBadRequestError) as e:
            get_resource("test", self.client_obj, "path")

        self.assertEqual(str(e.exception), "HTTP-error-code: 400, Message: The request is missing or has a bad parameter.")
    
    @mock.patch("tap_twitter_ads.sync.Cursor", side_effect=Mockresponse(400, [{"message":"This mesaage from response 400"}]))
    ...
    @mock.patch("tap_twitter_ads.sync.Cursor", side_effect=Mockresponse(401))   
    ...
    @mock.patch("tap_twitter_ads.sync.Cursor", side_effect=Mockresponse(401, [{"message":"This mesaage from response 401"}]))   
    ...
    @mock.patch("tap_twitter_ads.sync.Cursor", side_effect=Mockresponse(403))
    ...
    @mock.patch("tap_twitter_ads.sync.Cursor", side_effect=Mockresponse(403, [{"message":"This mesaage from response 403"}]))
    ...
    @mock.patch("tap_twitter_ads.sync.Cursor", side_effect=Mockresponse(404))
    def test_404_error_custom_message(self, mocked_cursor, mocked_request):
        ...
        with self.assertRaises(client.TwitterAdsNotFoundError) as e:
            get_resource("test", self.client_obj, "obj")
            
        self.assertEqual(str(e.exception), "HTTP-error-code: 404, Message: The resource you have specified cannot be found.")

    @mock.patch("tap_twitter_ads.sync.Cursor", side_effect=Mockresponse(404, [{"message":"This mesaage from response 404"}]))
    ...
    @mock.patch("tap_twitter_ads.sync.Cursor", side_effect=Mockresponse(405))
    ...
    @mock.patch("tap_twitter_ads.sync.Cursor", side_effect=Mockresponse(405, [{"message":"This mesaage from response 405"}]))
    ...
    @mock.patch("tap_twitter_ads.sync.Cursor", side_effect=Mockresponse(408))
    ...
    @mock.patch("tap_twitter_ads.sync.Cursor", side_effect=Mockresponse(408, [{"message":"This mesaage from response 408"}]))
    ...
    @mock.patch("tap_twitter_ads.sync.Cursor", side_effect=Mockresponse(429))
    ...
    @mock.patch("tap_twitter_ads.sync.Cursor", side_effect=Mockresponse(429, [{"message":"This mesaage from response 429"}]))
    ...
    @mock.patch("tap_twitter_ads.sync.Cursor", side_effect=Mockresponse(500))
    ...
    @mock.patch("tap_twitter_ads.sync.Cursor", side_effect=Mockresponse(500, [{"message":"This mesaage from response 500"}]))
    ...
    @mock.patch("tap_twitter_ads.sync.Cursor", side_effect=Mockresponse(503))
    ...
    @mock.patch("tap_twitter_ads.sync.Cursor", side_effect=Mockresponse(503, [{"message":"This mesaage from response 503"}]))
...
class TestExceptionHandlingForPost(unittest.TestCase):
    ...
    @mock.patch("tap_twitter_ads.sync.Request", side_effect=Mockresponse(400))
    def test_400_error_post_custom_message(self, mocked_request):
        ...
        with self.assertRaises(client.TwitterAdsBadRequestError) as e:
            post_resource("test", self.client_obj, "path")

        self.assertEqual(str(e.exception), "HTTP-error-code: 400, Message: The request is missing or has a bad parameter.")
    
    @mock.patch("tap_twitter_ads.sync.Request", side_effect=Mockresponse(400, [{"message":"This mesaage from response 400"}]))
    ...
    @mock.patch("tap_twitter_ads.sync.Request", side_effect=Mockresponse(401))   
    ...
    @mock.patch("tap_twitter_ads.sync.Request", side_effect=Mockresponse(401, [{"message":"This mesaage from response 401"}]))   
    ...
    @mock.patch("tap_twitter_ads.sync.Request", side_effect=Mockresponse(403))
    ...
    @mock.patch("tap_twitter_ads.sync.Request", side_effect=Mockresponse(403, [{"message":"This mesaage from response 403"}]))
    ...
    @mock.patch("tap_twitter_ads.sync.Request", side_effect=Mockresponse(404))
    def test_404_error_custom_message(self, mocked_request):
        ...
        with self.assertRaises(client.TwitterAdsNotFoundError) as e:
            post_resource("test", self.client_obj, "obj")
            
        self.assertEqual(str(e.exception), "HTTP-error-code: 404, Message: The resource you have specified cannot be found.")

    @mock.patch("tap_twitter_ads.sync.Request", side_effect=Mockresponse(404, [{"message":"This mesaage from response 404"}]))
    ...
    @mock.patch("tap_twitter_ads.sync.Request", side_effect=Mockresponse(405))
    ...
    @mock.patch("tap_twitter_ads.sync.Request", side_effect=Mockresponse(405, [{"message":"This mesaage from response 405"}]))
    ...
    @mock.patch("tap_twitter_ads.sync.Request", side_effect=Mockresponse(408))
    ...
    @mock.patch("tap_twitter_ads.sync.Request", side_effect=Mockresponse(408, [{"message":"This mesaage from response 408"}]))
    ...
    @mock.patch("tap_twitter_ads.sync.Request", side_effect=Mockresponse(429))
    ...
    @mock.patch("tap_twitter_ads.sync.Request", side_effect=Mockresponse(429, [{"message":"This mesaage from response 429"}]))
    ...
    @mock.patch("tap_twitter_ads.sync.Request", side_effect=Mockresponse(500))
    ...
    @mock.patch("tap_twitter_ads.sync.Request", side_effect=Mockresponse(500, [{"message":"This mesaage from response 500"}]))
    ...
    @mock.patch("tap_twitter_ads.sync.Request", side_effect=Mockresponse(503))
    ...
    @mock.patch("tap_twitter_ads.sync.Request", side_effect=Mockresponse(503, [{"message":"This mesaage from response 503"}]))
